...
# 读取停用词表
stop_words = read_stop_words('ban.txt')

# 读取训练集和测试集数据
train_data = read_data('train_split.txt')
test_data = read_data('test_split.txt')

# 计算TF-IDF特征
train_features, test_features = calculate_tfidf_features(train_data, test_data, stop_words)
